...
TEST(FindConsensusAndProfile, GivenOneString_Expect_ConsensusIdenticToInput) {
  auto sequences = read_from_file::ReadFastaFromFile(kCovidFastaFileName);
...
TEST(FindConsensusAndProfile, GivenOneString_Expect_CorrectProfile) {
  ...
  auto sequences = read_from_file::ReadFastaFromFile(kCovidShortFastaFileName);
...
TEST(FindConsensusAndProfile, GivenMultipleStrings_Expect_ConsensusIdenticToInput) {
  auto sequences = read_from_file::ReadFastaFromFile(kMultipleFastaEqualLength);
