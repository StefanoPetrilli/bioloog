...
TEST(RestrictionSite, GivenOneRestrictionSiteReturnExpectedResult) {
...
TEST(RestrictionSite, GivenOneLongRestrictionSiteReturnExpectedResult) {
...
TEST(
    RestrictionSite,
    GivenOneLongRestrictionSiteWithLenghtGreaterThan12ExpectedLongerRestrictionSiteFoundToBeLong12) {
  auto sequences =
...
TEST(RestrictionSiteDataset1, GivenDatasetExpectCorrectResult) {
...
TEST(RestrictionSiteDataset2, GivenDatasetExpectCorrectResult) {
...
TEST(RestrictionSiteDataset3,
     GivenCovidDnaMeasureTimeOfParallelAndSequentialExpectParallelToBeFaster) {
#ifdef _OPENMP
