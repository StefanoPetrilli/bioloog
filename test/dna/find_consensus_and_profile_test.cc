...
TEST(FindConsensusAndProfile, GivenOneStringExpectConsensusIdenticToInput) {
...
TEST(FindConsensusAndProfile, GivenOneStringExpectCorrectProfile) {
...
TEST(FindConsensusAndProfile,
     GivenMultipleStringsExpectConsensusIdenticToInput) {
...
TEST(FindConsensusAndProfile, GivenMultipleStringsExpectCorrectProfile) {
